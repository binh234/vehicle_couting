...
class Ui_ImageProcessingSettingsDialog(object):
    def setupUi(self, ImageProcessingSettingsDialog):
        ...
        # Detect
        self.detectTab_5 = QtWidgets.QWidget()
        self.detectTab_5.setObjectName("detectTab_5")
        self.layoutWidget7_5 = QtWidgets.QWidget(self.detectTab_5)
        self.layoutWidget7_5.setGeometry(QtCore.QRect(10, 10, 401, 221))
        self.layoutWidget7_5.setObjectName("layoutWidget7_5")
        self.verticalLayout_50 = QtWidgets.QVBoxLayout(self.layoutWidget7_5)
        self.verticalLayout_50.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_50.setObjectName("verticalLayout_50")
        self.horizontalLayout_60 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_60.setObjectName("horizontalLayout_60")
        self.label_85 = QtWidgets.QLabel(self.layoutWidget7_5)
        self.label_85.setMinimumSize(QtCore.QSize(0, 27))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_60.addWidget(self.label_85)
        self.detectConfidenceEdit = QtWidgets.QLineEdit(self.layoutWidget7_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.detectConfidenceEdit.sizePolicy().hasHeightForWidth())
        self.detectConfidenceEdit.setSizePolicy(sizePolicy)
        self.detectConfidenceEdit.setMinimumSize(QtCore.QSize(50, 27))
        self.detectConfidenceEdit.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.detectConfidenceEdit.setFont(font)
        self.detectConfidenceEdit.setObjectName("detectConfidenceEdit")
        self.horizontalLayout_60.addWidget(self.detectConfidenceEdit)
        self.label_86 = QtWidgets.QLabel(self.layoutWidget7_5)
        self.label_86.setMinimumSize(QtCore.QSize(0, 27))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_60.addWidget(self.label_86)
        self.verticalLayout_50.addLayout(self.horizontalLayout_60)

        self.horizontalLayout_61 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_61.setObjectName("horizontalLayout_61")
        self.label_87 = QtWidgets.QLabel(self.layoutWidget7_5)
        self.label_87.setMinimumSize(QtCore.QSize(0, 27))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.detectNMSThreshEdit = QtWidgets.QLineEdit(self.layoutWidget7_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.detectNMSThreshEdit.sizePolicy().hasHeightForWidth())
        self.detectNMSThreshEdit.setSizePolicy(sizePolicy)
        self.detectNMSThreshEdit.setMinimumSize(QtCore.QSize(50, 27))
        self.detectNMSThreshEdit.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.detectNMSThreshEdit.setFont(font)
        self.detectNMSThreshEdit.setObjectName("detectNMSThreshEdit")
        self.horizontalLayout_61.addWidget(self.detectNMSThreshEdit)
        self.label_88 = QtWidgets.QLabel(self.layoutWidget7_5)
        self.label_88.setMinimumSize(QtCore.QSize(0, 27))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_61.addWidget(self.label_88)
        self.verticalLayout_50.addLayout(self.horizontalLayout_61)
        
        spacerItem6 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_50.addItem(spacerItem6)
        self.resetDetectToDefaultsButton = QtWidgets.QPushButton(self.layoutWidget7_5)
        self.resetDetectToDefaultsButton.setObjectName("resetDetectToDefaultsButton")
        self.verticalLayout_50.addWidget(self.resetDetectToDefaultsButton)
        self.tabWidget.addTab(self.detectTab_5, "")
        ...
        ImageProcessingSettingsDialog.setTabOrder(self.resetCannyToDefaultsButton, self.detectConfidenceEdit)
        # Detect
        ImageProcessingSettingsDialog.setTabOrder(self.detectConfidenceEdit, self.detectNMSThreshEdit)
        ImageProcessingSettingsDialog.setTabOrder(self.detectNMSThreshEdit, self.resetDetectToDefaultsButton)
    ...
    def retranslateUi(self, ImageProcessingSettingsDialog):
        ...
        # Detect
        self.label_85.setText(_translate("ImageProcessingSettingsDialog", "Confidence:"))
        self.label_86.setText(_translate("ImageProcessingSettingsDialog", "[0-1]"))
        self.label_87.setText(_translate("ImageProcessingSettingsDialog", "NMS Threshold:"))
        self.label_88.setText(_translate("ImageProcessingSettingsDialog", "[0-1]"))
        self.resetDetectToDefaultsButton.setText(_translate("ImageProcessingSettingsDialog", "Reset to Defaults"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.detectTab_5), _translate("ImageProcessingSettingsDialog", "Detect"))
